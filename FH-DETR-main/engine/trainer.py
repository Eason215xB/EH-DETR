...
class BaseTrainer:
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        weights decay, and number of iterations.
        ...
        Args:
            ...
            decay (float, optional): The weights decay for the optimizer. Default: 1e-5.
        ...
        for module_name, module in model.named_modules():
            for param_name, param in module.named_parameters(recurse=False):
                ...
                if 'bias' in fullname:  # bias (no decay)
                    g[2].append(param)
                elif isinstance(module, bn):  # weights (no decay)
                    g[1].append(param)
        ...
        LOGGER.info(
            ...
            f'{len(g[1])} weights(decay=0.0), {len(g[0])} weights(decay={decay}), {len(g[2])} bias(decay=0.0)')
        return optimizer
